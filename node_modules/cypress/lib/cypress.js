"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\luigi\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.426\\out\\buildHook\\index.js').default({tool: 'cypress', checkSum: '201eca36b6f70d70d405fdAFFNUh0GWFRQVVEFVVZXDQZRVlQD', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/luigi/.vscode/extensions/wallabyjs.console-ninja-1.0.426/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress', checkSum: '201eca36b6f70d70d405fdAFFNUh0GWFRQVVEFVVZXDQZRVlQD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

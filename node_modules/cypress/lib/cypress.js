"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\luigi\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.430\\out\\buildHook\\index.js').default({tool: 'cypress', checkSum: '203d0ae60ce95cc9804865AlAeUksGCgZTXFMBVwwLCAMODgNX', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/luigi/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress', checkSum: '203d0ae60ce95cc9804865AlAeUksGCgZTXFMBVwwLCAMODgNX', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
